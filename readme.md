[![Java CI with Maven](https://github.com/Hassantanveeer/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/Hassantanveeer/spring-petclinic/actions/workflows/maven.yml)
